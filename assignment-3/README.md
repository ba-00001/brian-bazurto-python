...
**Go to:** [week-3/assignment-3/README.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/README.md)
...
| **Video script** | [VIDEO-SCRIPT.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/VIDEO-SCRIPT.md) |
| **Mindset Response** | [Motivation and Mindset](#mindset-response--motivation-and-mindset) |

## Files (all in the other repository, branch `assignment-3`)

| File | What it does |
| --- | --- |
| [warmup1.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/warmup1.py) | Hardcoded score → letter grade with `if`/`elif`/`else` |
| [warmup2.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/warmup2.py) | Age from `input()` → Child / Teen / Adult / Senior, ranges checked with `and` |
| [warmup3.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/warmup3.py) | Five Boolean expressions, each with a comment explaining the result |
| [warmup4.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/warmup4.py) | Sign and parity in two separate blocks; zero handled as its own case |
| [mini_project.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/mini_project.py) | Day Planner — 9 suggestions, case-insensitive, friendly fallbacks |
...
| 3 | Control Flow | this page → [week-3/assignment-3](https://github.com/ba-00001/python-intro-homework/blob/assignment-3/week-3/assignment-3/README.md) | [python-intro-homework#2](https://github.com/ba-00001/python-intro-homework/pull/2) |
