...
**Go to:** [week-2/assignment-2/README.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/README.md)
...
| **Video script** | [VIDEO-SCRIPT.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/VIDEO-SCRIPT.md) |
| **Mindset Response** | [AI for Learning](#mindset-response--ai-for-learning) |

## Files (all in the other repository, branch `assignment-2`)

| File | What it does |
| --- | --- |
| [warmup1.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/warmup1.py) | Prints `Python is working!`; command and output recorded as comments |
| [warmup2.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/warmup2.py) | Navigation commands recorded; asks for today's date and echoes it back |
| [warmup3.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/warmup3.py) | Real `git log --oneline` output recorded; prints what I learned this week |
| [warmup4.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/warmup4.py) | Deliberate `TypeError`, the traceback, the cause, and the `int()` fix |
| [mini_project.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/mini_project.py) | Fahrenheit → Celsius, rounded to one decimal with an f-string |
...
| 2 | CLI & Professional Environment | this page → [week-2/assignment-2](https://github.com/ba-00001/python-intro-homework/blob/assignment-2/week-2/assignment-2/README.md) | [python-intro-homework#1](https://github.com/ba-00001/python-intro-homework/pull/1) |
