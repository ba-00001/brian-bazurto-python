...
**Go to:** [week-6/assignment-6/README.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/README.md)
...
| **Video script** | [VIDEO-SCRIPT.md](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/VIDEO-SCRIPT.md) |
| **Mindset Response** | [Peer Collaboration](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/README.md#mindset-response--peer-collaboration) |

## Files (all in the other repository, branch `assignment-6`)

| File | What it does |
| --- | --- |
| [warmup1.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/warmup1.py) | `greet(name, greeting="Hello")` called three ways — name only, both positional, greeting by keyword |
| [warmup2.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/warmup2.py) | Both temperature conversions, returning values rather than printing |
| [warmup3.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/warmup3.py) | Scope demo — the `NameError` kept as a comment, then `return` solving it |
| [warmup4.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/warmup4.py) | `is_valid_score(score)` returning `True`/`False`, called inside an `if` |
| [mini_project.py](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/mini_project.py) | Number Cruncher refactored — every operation its own function, `main()` dispatching |

The mini-project is a **new file**, not an edit of Assignment 5, so both
versions stay in the git history. The algorithms are unchanged; what moved is
where they live. `search()` now returns only an index and `main()` decides what
to print, which is what makes it reusable.
...
| 6 | Functions & Scope | this page → [week-6/assignment-6](https://github.com/ba-00001/python-intro-homework/blob/assignment-6/week-6/assignment-6/README.md) | [python-intro-homework#5](https://github.com/ba-00001/python-intro-homework/pull/5) |
